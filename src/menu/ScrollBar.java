...
public class ScrollBar extends AbstractButton{
	...
	private long scrollClickRepeatLastTime;
		...
		if(ud){
			...
			buttonMinus = new Button(x, y, "btnUp") {
				...
				protected void update() {
					if(mouseLeft && System.currentTimeMillis()-scrollClickRepeatLastTime>scrollClickRepeat){
						scrollClickRepeatLastTime = System.currentTimeMillis();
